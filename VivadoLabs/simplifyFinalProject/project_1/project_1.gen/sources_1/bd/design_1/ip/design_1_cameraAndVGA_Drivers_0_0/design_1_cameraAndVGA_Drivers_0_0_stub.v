...
module design_1_cameraAndVGA_Drivers_0_0(vga_r, vga_g, vga_b, vga_hs, vga_vs, addressWrite, 
  ...
  filterSw, initFinish)
/* synthesis syn_black_box black_box_pad_pin="vga_r[3:0],vga_g[3:0],vga_b[3:0],vga_hs,vga_vs,addressWrite[18:0],dataWrite[11:0],wea[0:0],addressRead[18:0],dataRead[11:0],PCLK,DIN[7:0],VSYNC,HS,clk,clk25,reset,debugLed,startSw,filterSw,initFinish" */;
  output [3:0]vga_r;
  output [3:0]vga_g;
  output [3:0]vga_b;
  output vga_hs;
