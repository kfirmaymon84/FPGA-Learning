...
# The below constraint is added to resolve timing issues in Vivado 2016.3. In 2016.3 the Vivado Placer places MMCM and BUGGCE very far that causes large routing delay and timing failure. This constraint places BUFGCE_clk_samp_i0 in XOY1 clock region i.e., near to MMCM. 
