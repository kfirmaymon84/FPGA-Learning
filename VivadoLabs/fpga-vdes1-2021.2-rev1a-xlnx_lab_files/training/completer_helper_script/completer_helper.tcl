...
proc projectCreate {} {
   ...
   if {[logicValue $isLangNotSelected]} {
     ...
     if {[logicValue $isZed]} {
         ...
         create_project -force $projName $trainingPath/training/$tcName/$demoOrLab/$platform/$language -part xczu7ev-ffvc1156-2-e
         ...
         create_project -force $projName $trainingPath/training/$tcName/$demoOrLab/$platform/$language -part xc7k70tfbg484-2 
          ...
          create_project -force $projName $trainingPath/training/$tcName/$demoOrLab/$platform/$language -part xcvc1902-vsva2197-2MP-e-S 
