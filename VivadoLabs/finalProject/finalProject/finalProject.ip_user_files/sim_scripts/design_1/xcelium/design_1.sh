...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../finalProject.gen/sources_1/bd/design_1/ipshared/62b6" \
       +incdir+"$ref_dir/../../../../finalProject.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"../../../../finalProject.gen/sources_1/bd/design_1/ipshared/62b6" \
       +incdir+"../../../../finalProject.gen/sources_1/bd/design_1/ipshared/ec67/hdl"
}
